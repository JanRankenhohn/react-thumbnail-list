...
export default function ThumbnailListMainContentWrapper(props: ThumbnailListMainContentWrapperProps) {
...
type ThumbnailListMainContentWrapperProps = {
  grid?: BreakpointType;
  spacing: number;
};

ThumbnailListMainContentWrapper.defaultProps = {
  spacing: 2,
};
